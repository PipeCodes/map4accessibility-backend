    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('place.id')->hidden()->label('Place ID'),
                Tables\Columns\TextColumn::make('place.latitude')->label('Place Latitude'),
                Tables\Columns\TextColumn::make('place.longitude')->label('Place Longitude'),
